...
knitr::include_graphics("phase_transition_pic.pdf")
```
...
knitr::include_graphics("phase_transition_pic_fdr.pdf")
```
...
knitr::include_graphics("phase_transition_comparaison.pdf")
```
